...
def stdo(flag = 4, string="No Info Found", frame_info=None, end='\n'):
...
""".format(
        ...
        print("[{0}] - INF: {1}".format(currentTime, string), end=end)

    elif flag == 2:
        print("[{0}] - WRN: {1}".format(currentTime, string), end=end)
...
[{0}] - ERR:   Invalid arguments!
    ...
    """.format(
            ...
            print("[{0}] - ERR:    {1}".format(currentTime, string), end=end)
    elif flag == 4:
        print("[{0}] - DBG:    {1}".format(currentTime, string), end=end)
